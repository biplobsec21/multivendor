                ...
                <div class="col">
                    <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0 wow animate__animated animate__fadeInUp"
                        ...
                        <ul class="contact-infor">
                            ...
                            <li><img src="{{ asset('assets/front/imgs/theme/icons/icon-clock.svg') }}"
        ...
        <div class="row align-items-center">
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 text-end d-none d-md-block">
                <div class="mobile-social-icon">
                    ...
                    <a href="#">
                        <img src="{{ asset('assets/front/imgs/theme/icons/icon-facebook-white.svg') }}"
                            alt="" /></a>
                    {{-- <a href="{{ $setting->twitter }}"> --}}
                    <a href="#">
                        <img src="{{ asset('assets/front/imgs/theme/icons/icon-twitter-white.svg') }}"
                            alt="" /></a>
                    <a href="#">
                        <img src="{{ asset('assets/front/imgs/theme/icons/icon-instagram-white.svg') }}"
                            alt="" /></a>
                    <a href="#">
                        <img src="{{ asset('assets/front/imgs/theme/icons/icon-pinterest-white.svg') }}"
                            alt="" /></a>
                    {{-- <a href="{{ $setting->youtube }}"> --}}
                    <a href="#">
                        <img src="{{ asset('assets/front/imgs/theme/icons/icon-youtube-white.svg') }}"
                            alt="" /></a>
                </div>
