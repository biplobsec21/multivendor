                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <ul class="language-dropdown">
                                    <li>
                                        <a href="#"><img src="{{ asset('assets/front/imgs/theme/flag-fr.png') }}"
                                                alt="" />Français</a>
                                    </li>
                                    <li>
                                        <a href="#"><img src="{{ asset('assets/front/imgs/theme/flag-dt.png') }}"
                                                alt="" />Deutsch</a>
                                    </li>
                                    <li>
                                        <a href="#"><img src="{{ asset('assets/front/imgs/theme/flag-ru.png') }}"
                                                alt="" />Pусский</a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <div class="header-action-icon-2">
                                ...
                                <a href="#">
                                    <img class="svgInject" alt="Nest"
                                        src="{{ asset('assets/front/imgs/theme/icons/icon-compare.svg') }}" />
                                </a>
        ...
        <div class="container">
            <div class="header-wrap header-space-between position-relative">
                <div class="logo logo-width-1 d-block d-lg-none">
                    <a href="index.html"><img src="{{ asset('assets/front/imgs/theme/logo.svg') }}"
                            alt="logo" /></a>
                </div>
                            ...
                            <div class="more_slide_open" style="display: none">
                                <div class="d-flex categori-dropdown-inner">
                                    <ul>
                                        <li>
                                            <a href="shop-grid-right.html"> <img
                                                    src="{{ asset('assets/front/imgs/theme/icons/icon-1.svg') }}"
                                                    alt="" />Milks and Dairies</a>
                                        </li>
                                        <li>
                                            <a href="shop-grid-right.html"> <img
                                                    src="{{ asset('assets/front/imgs/theme/icons/icon-2.svg') }}"
                                    ...
                                    <ul class="end">
                                        <li>
                                            <a href="shop-grid-right.html"> <img
                                                    src="{{ asset('assets/front/imgs/theme/icons/icon-3.svg') }}"
                                                    alt="" />Wines & Drinks</a>
                                        </li>
                                        <li>
                                            <a href="shop-grid-right.html"> <img
                                                    src="{{ asset('assets/front/imgs/theme/icons/icon-4.svg') }}"
                                                    alt="" />Fresh Seafood</a>
                                        </li>
                                    </ul>
                                </div>
                ...
                <div class="hotline d-none d-lg-flex">
                    ...
                    <p>{{ $setting ? $setting->support_phone : '' }}<span>24/7 Support Center</span></p>
                </div>
        ...
        <div class="mobile-header-content-area">
            ...
            <div class="mobile-social-icon mb-50">
                ...
                <a href="#"><img src="{{ asset('assets/front/imgs/theme/icons/icon-twitter-white.svg') }}"
                        alt="" /></a>
                <a href="#"><img src="{{ asset('assets/front/imgs/theme/icons/icon-instagram-white.svg') }}"
                        alt="" /></a>
                <a href="#"><img src="{{ asset('assets/front/imgs/theme/icons/icon-pinterest-white.svg') }}"
                        alt="" /></a>
