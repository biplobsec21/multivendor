    ...
    <div class="dashboard-menu">
        <ul class="nav flex-column" role="tablist">
            ...
            <li class="nav-item">
                ...
                <a class="nav-link {{ $route == 'user.order.page' ? 'active' : '' }}" href="#"><i
            ...
            <li class="nav-item">
                ...
                <a class="nav-link {{ $route == 'return.order.page' ? 'active' : '' }}" href="#"><i
            ...
            <li class="nav-item">
                {{-- <a class="nav-link {{ $route == 'user.track.order' ? 'active' : '' }}"
                    ...
                    Order</a> --}}
                <a class="nav-link {{ $route == 'user.track.order' ? 'active' : '' }}" href="#"><i
            ...
            <li class="nav-item">
                ...
                {{-- <a class="nav-link {{ $route == 'user.account.page' ? 'active' : '' }}" href="#"><i
            ...
            <li class="nav-item">
                ...
                <a class="nav-link {{ $route == 'user.change.password' ? 'active' : '' }}" href="#"><i
